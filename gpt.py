...
def beautify_text(text):
    ...
    "Каждое новое предложение начинай **с новой строки**.\n"
    "**Не делай лишних пустых строк и не вставляй абзацы. Только одна новая строка после точки.**\n"
    "Если после точки идёт новое предложение, оно всегда с новой строки, без дополнительных отступов."
    )
    user_prompt = (
